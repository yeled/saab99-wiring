...
wire('340', [(54, 120), (165, 120), (165, 86)], 60, 118.5); conn(110, 120, 8, 'ignition switch connector 58')

# ---- radio junction box 122 (pins in physical order 1 5 2 6 3 7 4 8) ----------
box(155, 70, 90, 16); txt(200, 66, '122 Radio junction box, 8-pole', 2.8, 'middle', w='bold')
...
txt(346, 141, 'left and right as on this car (check I1)', 2.2, fill='#555')
